...
def teacher(request):  # this section for my appointment
    ...
    group_name = str(group_name.first())  # convert to string
    ...
    return render(request, 'teacher/teacher.html', appointments)
...
def teacher_appointment_list(request):
    group_name = Group.objects.all().filter(user=request.user)  # get user grouped name
    group_name = str(group_name.first())  # convert to string
    #	if "Teacher" == group_name:
    user_name = request.user.get_username()  # Getting Username
    ...
    return render(request, 'teacher/teacher_create_appointment.html', appointments)
